    ...
    >
      ...
      {playingId === "pedestrian" ? (
        ...
        <g transform="translate(341.69, 117.74)" filter="url(#tf-shadow)">
          ...
          <path fill="rgba(76, 72, 59, 0.14)" transform="translate(0, 5)" d="M144.79,135.48V9.31c0-5.14-4.17-9.31-9.31-9.31H9.31C4.17,0,0,4.17,0,9.31v126.18c0,5.14,4.17,9.31,9.31,9.31-5.14,0-9.31,4.17-9.31,9.31v126.18c0,5.14,4.17,9.31,9.31,9.31h126.18c5.14,0,9.31-4.17,9.31-9.31v-126.18c0-5.14-4.17-9.31-9.31-9.31,5.14,0-9.31,4.17-9.31,9.31Z"/>
          {/* Brackets */}
      ...
      {playingId === "headlight" ? (
        ...
        <g transform="translate(486.68, 605.4)" filter="url(#tf-shadow)">
          ...
          <path fill="rgba(76, 72, 59, 0.14)" transform="translate(0, 5)" d="M0,10.59h12.13c13.05,0,23.65,10.6,23.65,23.65v39.99c0,13.05-10.6,23.65-23.65,23.65H0V10.59h0Z"/>
          {/* Physical Shadow Layer for Right Button */}
          <path fill="rgba(76, 72, 59, 0.14)" d="M558.31,10.59h12.13c13.05,0,23.65,10.6,23.65,23.65v39.99c0,13.05-10.6,23.65-23.65,23.65h-12.13V10.59h0Z" transform="translate(1152.3868 113.4808) rotate(-180)"/>
        ...
        <g transform="translate(486.68, 615.99)">
          ...
          >
            {/* Physical Shadow Layer for Left Button */}
            <path fill="rgba(76, 72, 59, 0.14)" transform="translate(0, 5)" d="M0,0h12.13c13.05,0,23.65,10.6,23.65,23.65v39.99c0,13.05-10.6,23.65-23.65,23.65H0V0h0Z"/>
            {/* Physical Shadow Layer for Right Button */}
            <path fill="rgba(76, 72, 59, 0.14)" d="M558.31,0h12.13C583.48,0,594.08,10.6,594.08,23.65v39.99c0,13.05-10.6,23.65-23.65,23.65h-12.13V0h0Z" transform="translate(1152.3868 92.2918) rotate(-180)"/>
