  ...
  return (
    ...
    >
      ...
      <g transform="translate(268.4, 602.94)">
        {playingId === "intercom" ? (
          <g>
            <rect fill="#4c483b" style={{ filter: "drop-shadow(0px 2px 8px rgba(76, 72, 59, 0.10))" }} width="128.81" height="177.45" rx="4.9" ry="4.9"/>
          ...
          >
            <rect fill="#ffffff" style={{ filter: "drop-shadow(0px 2px 8px rgba(76, 72, 59, 0.10))" }} width="128.81" height="177.45" rx="4.9" ry="4.9"/>
      ...
      {playingId === "tv" ? (
        ...
        >
          ...
          <rect fill="#4c483b" style={{ filter: "drop-shadow(0px 2px 8px rgba(76, 72, 59, 0.10))" }} x="369.53" y="176.73" width="212.62" height="366.61" rx="5.47" ry="5.47" transform="translate(115.81 835.88) rotate(-90)"/>
        ...
        >
          ...
          <rect fill="#ffffff" style={{ filter: "drop-shadow(0px 2px 8px rgba(76, 72, 59, 0.10))" }} x="369.53" y="176.73" width="212.62" height="366.61" rx="5.47" ry="5.47" transform="translate(115.81 835.88) rotate(-90)"/>
      ...
      <g transform="translate(877.37, 661.33)">
        {playingId === "washer" ? (
          <g>
            <rect fill="#4c483b" style={{ filter: "drop-shadow(0px 2px 8px rgba(76, 72, 59, 0.10))" }} width="252.44" height="337.77" rx="5.72" ry="5.72"/>
          ...
          <motion.g 
            ...
            whileTap={{ scale: 0.94, filter: "drop-shadow(0px 2px 6px rgba(76, 72, 59, 0.12))" }}
          >
            <rect fill="#ffffff" style={{ filter: "drop-shadow(0px 2px 8px rgba(76, 72, 59, 0.10))" }} width="252.44" height="337.77" rx="5.72" ry="5.72"/>
