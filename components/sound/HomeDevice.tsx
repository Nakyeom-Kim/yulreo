...
export default function HomeDevice({ playingId, playSound }: HomeDeviceProps) {
  return (
    ...
    >
      {/* Shelves */}
      <rect stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x="248.85" y="555.77" width="934.43" height="15.54"/>
      <rect stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x="248.85" y="1007.45" width="934.43" height="15.54"/>

      {/* TV Stand Post & Details */}
      <rect stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x="260.84" y="476.86" width="428.5" height="73.97"/>
      <rect stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x="269.16" y="484.24" width="200.55" height="59.21"/>
      <rect stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x="479.71" y="484.24" width="200.55" height="59.21"/>
      <line stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x1="368.51" y1="484.24" x2="368.51" y2="543.45"/>
      <line stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x1="370.36" y1="484.24" x2="370.36" y2="543.45"/>
      <line stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x1="579.06" y1="484.24" x2="579.06" y2="543.45"/>
      <line stroke="#4c483b" fill="none" strokeWidth={1} strokeMiterlimit={10} x1="580.91" y1="484.24" x2="580.91" y2="543.45"/>

      {/* Laundry Basket */}
      <polygon stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} points="732.33 858.08 862.33 858.08 847.86 999.1 746.8 999.1 732.33 858.08"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="745.14" y1="982.92" x2="849.52" y2="982.92"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="743.37" y1="965.65" x2="851.29" y2="965.65"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="741.47" y1="947.16" x2="853.19" y2="947.16"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="739.43" y1="927.33" x2="855.22" y2="927.33"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="737.24" y1="905.99" x2="857.41" y2="905.99"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="734.88" y1="882.98" x2="859.77" y2="882.98"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="843.76" y1="858.08" x2="833.42" y2="999.1"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="825.19" y1="858.08" x2="818.98" y2="999.1"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="806.61" y1="858.08" x2="804.55" y2="999.1"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="788.04" y1="858.08" x2="790.11" y2="999.1"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="769.47" y1="858.08" x2="775.67" y2="999.1"/>
      <line stroke="#4c483b" fill="none" strokeWidth={0.82} strokeMiterlimit={10} x1="750.9" y1="858.08" x2="761.24" y2="999.1"/>
      <path fill="#4c483b" d="M740.03,858.08l50.56-22.83c9.83-4.44,21.31-2.96,29.7,3.83l23.47,19h-103.73Z"/>
      ...
      {playingId === "tv" ? (
        ...
        >
          ...
          <rect fill="#FFF" stroke="#4c483b" strokeMiterlimit={10} x="379.53" y="186.73" width="192.62" height="346.61" transform="translate(835.88 -115.81) rotate(90)"/>
        </motion.g>
      ) : (
        <motion.g 
        ...
        >
          <rect fill="#4c483b" x="369.53" y="176.73" width="212.62" height="366.61" rx="5.47" ry="5.47" transform="translate(115.81 835.88) rotate(-90)"/>
          <rect fill="#4c483b" stroke="#FFF" strokeMiterlimit={10} x="379.53" y="186.73" width="192.62" height="346.61" transform="translate(835.88 -115.81) rotate(90)"/>
        </motion.g>
      )}
      ...
      <g transform="translate(877.37, 661.33)">
        {playingId === "washer" ? (
          <g>
            ...
            <circle fill="#4c483b" stroke="#FFF" strokeMiterlimit={10} cx="126.22" cy="208.65" r="104.99"/>
